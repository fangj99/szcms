...
function init(){
	...
	var plugin_ele_str = '<div id="trips-ad-plugin">'+
							...
							'<a href="http://en.trips.sanyatour.com/" target="_blank"><img src="http://cdn21.beyondsummits.com/sanya/p/img/1200/foot-bsl.png" alt="trips-sanya" title="trips-sanya"></a>'+
							'</div></div>'+
							'<div id="trips-ad-plugin-two">'+
							'<h2 id="trip-word2">没有符合要求的内容</h2>'+
							'<ul class="content">'+
							'</ul>'+
							'<ul class="buttons"><li><a href="http://en.trips.sanyatour.com/" target="_blank"><img src="http://cdn21.beyondsummits.com/sanya/p/img/1200/foot-bsl.png" alt="trips-sanya" title="trips-sanya"></a></li><li><span>↶</span></li></ul>'+
