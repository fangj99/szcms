...
// use common\models\Channel;
use yii;
class CategoryTreep extends yii\base\Object{
    ...
    public  function __construct(){
        ...
        $allCategories=Channel::find()->asArray()->all();
        ...
        foreach($allCategories as $v){
            ...
            $this->_childCategoryIds[$v['pid']][]=$v['id'];
            $this->_parentCategoryIds[$v['id']]=$v['pid'];
    ...
    public function getAllCategories(){
        ...
        if(!empty($this->_childCategoryIds)){
            foreach($this->_childCategoryIds[2] as $v){
